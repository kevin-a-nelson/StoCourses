...
def init_all_terms
  [ 20151, 20152, 20153, 20154, 20155 ].each { |term| update_courses(term) }
  [ 20161, 20162, 20163, 20164, 20165 ].each { |term| update_courses(term) }
  [ 20171, 20172, 20173, 20174, 20175 ].each { |term| update_courses(term) }
  [ 20181, 20182, 20183, 20184, 20185 ].each { |term| update_courses(term) }
  [ 20191, 20192, 20193 ].each { |term| update_courses(term) }
end
